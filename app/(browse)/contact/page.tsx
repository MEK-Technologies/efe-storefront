        ...
        <div className="container mx-auto px-4">
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-start">
            ...
            <div className="rounded-[2.5rem] bg-white p-10 shadow-xl shadow-stone-200/50 border border-stone-100">
               <h2 className="text-3xl font-bold text-stone-800 mb-8">Información de Contacto</h2>
               
               <div className="space-y-8">
                  <div className="flex items-start gap-5">
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-stone-100/80 text-stone-600">
                  ...
                  <div className="flex items-start gap-5 pt-8 border-t border-stone-100">
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-stone-800 text-stone-300">
            ...
            <div className="space-y-8">
                <div className="rounded-[2.5rem] bg-stone-800 p-10 shadow-xl text-white relative overflow-hidden">
                    ...
                    <h2 className="text-3xl font-bold mb-4 relative z-10">¿Listo para crecer?</h2>
