...
function makeBreadcrumbs(product: CommerceProduct) {
  // Use Medusa's collection (singular)
  const collection = product.collection

  return {
    Home: "/",
    [collection?.title || "Products"]: collection?.handle ? `/category/${collection.handle}` : "/search",
    [product.title || "Product"]: `/product/${product.handle}`,
    Reviews: "",
  }
}
