...
export function TextGridVariant({ items }: TextGridVariantProps) {
  ...
  return (
    <div className="mx-auto mb-10 mt-20 grid w-full max-w-container-md grid-cols-[repeat(_auto-fit,minmax(200px,1fr)_)] gap-6 @sm:px-8 @7xl:px-0 md:my-0 md:py-14">
